...
import { requireAdmin, requirePermission, requireTenantScope } from "../../middleware/guard";
...
router.get("/:tenantSlug", requireTenantScope(), requirePermission("iam:tenant:read"), getTenant);

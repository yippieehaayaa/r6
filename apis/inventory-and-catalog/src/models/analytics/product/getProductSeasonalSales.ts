...
const getProductSeasonalSales = async (
  ...
  if (variants.length === 0) {
    return { productId, seasons: [], bestSeason: null, worstSeason: null };
  }
  ...
  return { productId, seasons: seasonalResults, bestSeason, worstSeason };
};

export default getProductSeasonalSales;
